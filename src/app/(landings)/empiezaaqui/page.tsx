...
const TESTIMONIALS = [
  {
    ...
    quote: 'Manejo mis inversiones en equipo, pero necesitaba ingresar a Ruarte Reports para tener claridad y seguridad en cuanto a mis inversiones',
    name: 'Wiliam B.',
  ...
  },
  {
    ...
    quote: 'Carecía de entendimiento frente al análisis técnico por más que tuviera un master en finanzas. Ruarte Reports me permitió tener un manejo profesional en cuanto a mis análisis',
    name: 'Guido L.',
    role: 'Docente Universitario y Economista',
    initials: 'GL',
    delay: 'd1',
  },
  {
    video: 'https://assets.cdn.filesafe.space/KtUHW6Xfym4HTBF8Ujq8/media/69d57a533d829c73b2b7aa70.mp4',
    quote: 'Me costaba no dejarme llevar por el ruido del mercado. Ruarte Reports me ayudó a desarrollar una estrategia de inversión mucho más estructurada.',
    name: 'Ignacio M.',
    role: '',
    initials: 'IM',
  },
  {
    ...
    quote: 'Analizaba de manera amateur, con Ruarte Reports entendí que hay una forma de profesionalizar el análisis y mejorar la toma de decisiones',
    name: 'Christian M.',
    role: 'Dueño de Joyería',
    initials: 'CM',
    delay: 'd1',
  },
  {
    video: 'https://assets.cdn.filesafe.space/KtUHW6Xfym4HTBF8Ujq8/media/69d57c15ad0e3e3270605fdc.mp4',
    quote: 'No estaba conforme con los rendimientos de mi cartera, Ruarte Reports me ha dado una atención y solución muy personalizada en cuanto a mis inversiones.',
    name: 'Daniel B.',
    role: '',
    initials: 'DB',
  },
  {
    ...
    quote: 'Me costaba decidir cuándo comprar y cuándo vender, Ruarte Reports me ayudó a tomar decisiones de manera más clara',
    name: 'Eduardo B.',
